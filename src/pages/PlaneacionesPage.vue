<template>
  <q-page class="q-pa-xl bg-grey-2">
    <div class="text-h4 text-center text-primary q-mb-xl">📚 Planeacion Descargables</div>

    <div class="row q-col-gutter-xl justify-center">
      <div v-for="file in archivos" :key="file.nombre" class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
...
const archivos = [
  {
    nombre: 'PLANEACION AUTISTA (Word)',
    descripcion: 'Documento Word',
    url: '/recursos/PLANEACION AUTISTA.docx',
    icono: 'description',
